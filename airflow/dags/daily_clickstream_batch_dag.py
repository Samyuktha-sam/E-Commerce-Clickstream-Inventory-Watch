...
@dag(
    dag_id="daily_clickstream_batch_analysis_dag",
...
def daily_clickstream_batch_analysis_dag():
    @task
...
# Instantiate the DAG
daily_clickstream_batch_analysis_dag_instance = daily_clickstream_batch_analysis_dag()
